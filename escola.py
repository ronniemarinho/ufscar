...
az.plot_trace(gauss_fitted, var_names=["Intercept", "mat"], figsize=(20, 10))
plt.tight_layout()
...
print("Média do coeficiente 'mat':", gauss_fitted.posterior.mat.values.mean())
...
def plot_interval_prediction(mat, por, fitted):
    ...
    for interval in [0.38, 0.68]:
        az.plot_hdi(mat, fitted.posterior_predictive.por, hdi_prob=interval, color="firebrick")
